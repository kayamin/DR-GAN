...
def train_single_DRGAN(images, id_labels, pose_labels, Nd, Np, Nz, D_model, G_model, args):
    ...
    for epoch in range(1, args.epochs+1):
        ...
        for i, batch_data in enumerate(dataloader):
            ...
            portion_num = 5 if flag_D_strong else 2
...
def train_multiple_DRGAN(images_whole, id_labels_whole, pose_labels_whole, Nd, Np, Nz, D_model, G_model, args):
    ...
    flag_D_strong = False
    for epoch in range(1, args.epochs+1):
        # TODO: Use dataloader like single
        ...
        for i in range(epoch_time):
            ...
            if i % portion_num == 0:
                ...
                # Generatorの学習
                    Learn_G(D_model, loss_criterion, loss_criterion_gan, optimizer_G, generated,
                            batch_id_label, batch_ones_label, pose_code_label, epoch, steps, Nd, args,
                            generated_unique, batch_id_label_unique, pose_code_label_unique, batch_ones_label, minibatch_size_unique)
...
def Learn_G(D_model, loss_criterion, loss_criterion_gan, optimizer_G,
            generated, batch_id_label, batch_ones_label,
            pose_code_label, epoch, steps, Nd, args,
            generated_unique=None, batch_id_label_unique=None,
            pose_code_label_unique=None, minibatch_size_unique=None):
